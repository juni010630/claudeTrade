...
# 3차 (2026-06-10): 2:1 비율 — SL 조임. 1·2차 그리드는 SLEEVE_TP_SWEEP.md에 기록됨.
VARIANTS = [
    ("2:1 tp2.0/sl1.0", "1d", None, 2.0, 1.0),
    ("2:1 tp3.0/sl1.5", "1d", None, 3.0, 1.5),
    ("2:1 tp4.0/sl2.0", "1d", None, 4.0, 2.0),
    ("12h 2:1 3.0/1.5", "12h", 12, 3.0, 1.5),
    ("12h 2:1 2.0/1.0", "12h", 12, 2.0, 1.0),
]
